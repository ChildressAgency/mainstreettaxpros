...
add_action('wp_enqueue_scripts', 'mainstreettaxpros_scripts', 100);
function mainstreettaxpros_scripts(){
  wp_register_script(
    'bootstrap-script', 
...
/*  wp_register_script(
    'mainstreettaxpros-scripts', 
    get_template_directory_uri() . '/js/mainstreettaxpros-scripts.js', 
    array('jquery'), 
    '', 
    true
  ); */
  ...
  //wp_enqueue_script('mainstreettaxpros-scripts');  
}

add_action('wp_enqueue_scripts', 'mainstreettaxpros_styles');
function mainstreettaxpros_styles(){
  wp_register_style('bootstrap-css', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css');
  wp_register_style('google-fonts', 'https://fonts.googleapis.com/css?family=Roboto:400,700|Spectral+SC|Spectral:400,500');
  wp_register_style('mainstreettaxpros', get_template_directory_uri() . '/style.css');
  
  wp_enqueue_style('bootstrap-css');
  wp_enqueue_style('google-fonts');
  wp_enqueue_style('mainstreettaxpros');
}
...
register_nav_menus(array(
  ...
  'colophon_nav' => 'Colophon Navigation',
  'resources_nav' => 'Resources Navigation',
  'services_nav' => 'Services Navigation'
));
/**
...
function mainstreettaxpros_header_fallback_menu(){ ?>
  <div id="navbar" class="navbar-collapse collapse">
    <ul class="nav navbar-nav">
      <li<?php if(is_page('services') || is_singular('services_cpt')){ echo ' class="active"'; } ?>><a href="<?php echo home_url('services'); ?>">Services</a></li>
      <li<?php if(is_page('about-us')){ echo ' class="active"'; } ?>><a href="<?php echo home_url('about-us'); ?>">About Us</a></li>
      <li<?php if(is_page('resources') || is_singular('resources_cpt')){ echo ' class="active"'; } ?>><a href="<?php echo home_url('resources'); ?>">Resources</a></li>
